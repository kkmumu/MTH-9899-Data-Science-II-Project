...
def lgb_fit(model, X, y, X_valid, y_valid, X_train_valid, y_train_valid, X_test, y_test, early_stopping_rounds = 50, eval_metric = 'logloss'):
    ...
    #Print model report:
    print("\nModel Report")
    print("train r2: ", weight_r2_train, "valid r2: ", weight_r2_valid, 'test r2: ', weight_r2_test)
    return model
